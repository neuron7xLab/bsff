...
DISPOSITION_MEANING: dict[str, str] = {
    ...
    "LOGICAL_STRUCTURE_PRESENT": "argument exposes premise and conclusion (structure only, not proven sound)",
    "LOGICAL_STRUCTURE_INCOMPLETE": "conclusion asserted without a stated premise",
