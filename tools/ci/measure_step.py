...
def proc_io() -> tuple[dict[str, int | None], dict[str, str | None]]:
    ...
    }, {"measurement_status": "AVAILABLE", "reason": None}
...
def run(argv: list[str] | None = None) -> int:
    ...
    doc: dict[str, Any] = {
        ...
        "network_bytes_received": delta(
            net_after.get("bytes_received"),
            net_before.get("bytes_received"),
        ),
        "exit_code": exit_code,
        "timed_out": timed_out,
        ...
        "measurement_status": {
            ...
            "max_rss": {
                "measurement_status": "AVAILABLE",
                "reason": "resource.getrusage.ru_maxrss",
            },
            "io": io_status,
            "network": net_status,
            "filesystem_inputs": {
                "measurement_status": "UNAVAILABLE_BY_PLATFORM_LIMITATION",
                "reason": "not reliably enumerable for arbitrary subprocess argv",
            },
            "filesystem_outputs": {
                "measurement_status": "UNAVAILABLE_BY_PLATFORM_LIMITATION",
                "reason": "not reliably enumerable for arbitrary subprocess argv",
