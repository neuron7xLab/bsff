...
from validate_truth_contract import build_corpus, find_forbidden_claims  # noqa: E402
...
def test_repo_corpus_is_clean():
    ...
    # are excluded by build_corpus, exactly as the validator excludes them.
    assert find_forbidden_claims(build_corpus()) == []
